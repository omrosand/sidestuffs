...
function onYouTubeIframeAPIReady() {
  ...
  ctrlq.innerHTML =
    '<div id="myBtn" id="play-video" class=""/><div id="youtube-player"></div>';
  ...
  function togglePlayButton(play) {
    document.getElementById("myBtn").className = play
      ? "fa fa-pause-circle fa-5x"
      : "fa fa-play-circle fa-5x";
    listeningTo.innerHTML = play
      ? "<span class='animateCurrentSong'>Lofi hip hop <i style='font-size:13px' class='fas'>&#xf001;</i></span>" +
        "<br>" +
        "<a class='source' href='https://www.youtube.com/watch?v=jfKfPfyJRdk' target='_blank'>source</a>"
